...
import com.bilgiyazan.malzemeiste.Activity.SeeAllActivity;
import com.bilgiyazan.malzemeiste.R;

/**
 * Simple view holder for a single text view.
 */
public class MakinalarViewTitleHolder extends RecyclerView.ViewHolder {

    private TextView mTextView;
    private TextView mTextView1;

    public MakinalarViewTitleHolder(View view) {
        super(view);
