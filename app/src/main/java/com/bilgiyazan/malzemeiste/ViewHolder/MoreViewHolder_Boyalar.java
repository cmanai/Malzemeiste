...
public class MoreViewHolder_Boyalar extends ParentViewHolder {
    ...
    public MoreViewHolder_Boyalar(@NonNull View itemView) {
        super(itemView);
    ...
    public void bind(@NonNull MoreAdapterModelBoyalar moreAdapterModel) {
     ...
     /*   mArrowExpandImageView.bringToFront();
        ...
        name_more.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (MoreViewHolder_Boyalar.super.isExpanded()) {
                    MoreViewHolder_Boyalar.super.collapseView();
                } else {
                    MoreViewHolder_Boyalar.super.expandView();
