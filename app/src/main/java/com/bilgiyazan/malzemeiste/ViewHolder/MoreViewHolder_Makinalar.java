...
public class MoreViewHolder_Makinalar extends ParentViewHolder {
    ...
    public MoreViewHolder_Makinalar(@NonNull View itemView) {
        super(itemView);
    ...
    public void bind(@NonNull MoreAdapterModelMakinalar moreAdapterModel) {
     ...
     /*   mArrowExpandImageView.bringToFront();
        ...
        name_more.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (MoreViewHolder_Makinalar.super.isExpanded()) {
                    MoreViewHolder_Makinalar.super.collapseView();
                } else {
                    MoreViewHolder_Makinalar.super.expandView();
