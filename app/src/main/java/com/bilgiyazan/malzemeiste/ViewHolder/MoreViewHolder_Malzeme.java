...
public class MoreViewHolder_Malzeme extends ParentViewHolder {
    ...
    public MoreViewHolder_Malzeme(@NonNull View itemView) {
        super(itemView);
    ...
    public void bind(@NonNull MoreAdapterModelMalzeme moreAdapterModel) {
     ...
     /*   mArrowExpandImageView.bringToFront();
        ...
        name_more.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (MoreViewHolder_Malzeme.super.isExpanded()) {
                    MoreViewHolder_Malzeme.super.collapseView();
                } else {
                    MoreViewHolder_Malzeme.super.expandView();
