...
import com.bilgiyazan.malzemeiste.Model.A_Starjet;
import com.bilgiyazan.malzemeiste.Model.OKI;
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        ...
        if (contentsRolands != null) {
            ...
            makinalar_detail_share.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    sendIntent.putExtra(Intent.EXTRA_TEXT, contentsRolands.get(position).getShare_Link());
        ...
        makinalar_detail_email.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra(Intent.EXTRA_SUBJECT, "Ürün kodu: " + contentsRolands.get(position).getKod());
