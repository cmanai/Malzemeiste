...
public class Temizleme {
    ...
    public List<com.bilgiyazan.malzemeiste.Model.Temizleme_Value> getTemizleme_Value() {
        return Temizleme_Value;
    }

    public void setTemizleme_Value(List<com.bilgiyazan.malzemeiste.Model.Temizleme_Value> temizleme_Value) {
