...
import com.bilgiyazan.malzemeiste.Adapter.KampanyalarAdapter;
...
public class KampanyalarFragment extends Fragment {
    ...
    private List<Kampanyalar> kampanyalars;

    private DatabaseReference mDatabase;
    private ViewHolder mViews;
    private KampanyalarAdapter mAdapter;
    private int mHeaderDisplay;
    private boolean mAreMarginsFixed;
    private Random mRng = new Random();
    private Toast mToast = null;
    private SwipeRefreshLayout swipeKampanyalar;

    SharedPreferences prefs;

    public static KampanyalarFragment newInstance() {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.kampanyalar_fragment, container, false);
        swipeKampanyalar = (SwipeRefreshLayout) view.findViewById(R.id.swipeKampanyalar);
...
/*        if (!isInternetPresent) {
        ...
        swipeKampanyalar.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            @Override
        ...
        swipeKampanyalar.setColorSchemeResources(R.color.colorPrimary);
        ...
        mDatabase.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot postSnapshot) {
                ...
                Log.e("kampanyalar size frag", kampanyalars.size() + "");

                mViews = new KampanyalarFragment.ViewHolder(view);
                mViews.initViews(new LayoutManager(getActivity()));
                mAdapter = new KampanyalarAdapter(getActivity(), mHeaderDisplay, getActivity(), kampanyalars);
        ...
        if (isInternetPresent) {
            mDatabase.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot postSnapshot) {
                    ...
                    mViews.setAdapter(mAdapter);
                    mAdapter.notifyDataSetChanged();
                    swipeKampanyalar.setRefreshing(false);
    ...
    private static class ViewHolder {
        ...
        public ViewHolder(View view) {
            mRecyclerView = (RecyclerView) view.findViewById(R.id.kampanyalar_recyclerView);
