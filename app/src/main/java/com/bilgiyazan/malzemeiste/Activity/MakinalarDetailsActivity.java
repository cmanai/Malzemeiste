...
public class MakinalarDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.makinalar_details_layout);
       ...
       // Details_Link_value.setText(getIntent().getStringExtra("Share_Link"));
        ...
        prefs = MakinalarDetailsActivity.this.getSharedPreferences("malzemeiste", Context.MODE_PRIVATE);
        ...
        more_item_details_call.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (ActivityCompat.checkSelfPermission(MakinalarDetailsActivity.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {

                    // Should we show an explanation?
                    ActivityCompat.requestPermissions(MakinalarDetailsActivity.this,
                            new String[]{Manifest.permission.CALL_PHONE},
                            1);
                } else {

                    MakinalarDetailsActivity.this.startActivity(callIntent);
        ...
        more_item_details_email.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    MakinalarDetailsActivity.this.startActivity(Intent.createChooser(intent, "E-posta ile Via ..."));
                } catch (android.content.ActivityNotFoundException ex) {
                    Toast.makeText(MakinalarDetailsActivity.this, "Hiçbir e-posta istemcisi yüklü değil.", Toast.LENGTH_SHORT).show();
                }
            }
        });
        more_item_details_share.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                MakinalarDetailsActivity.this.startActivity(Intent.createChooser(sendIntent, "İle paylaş"));
            }
        });
        ...
        if (!getIntent().getStringExtra("Image").equals("------"))
            Glide.with(MakinalarDetailsActivity.this).load(getIntent().getStringExtra("Image")).into(header_details);
