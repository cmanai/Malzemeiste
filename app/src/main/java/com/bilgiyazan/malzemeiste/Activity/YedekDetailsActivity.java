...
public class YedekDetailsActivity extends AppCompatActivity {
    ...
    TextView Details_Uyumlu_value;
    TextView more_item_details_kdv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.yedek_details_layout);
        ...
        more_item_details_kdv = (TextView) findViewById(R.id.more_item_details_kdv);

        Details_Uyumlu_value = (TextView) findViewById(R.id.Details_Uyumlu_value);
        ...
        prefs = YedekDetailsActivity.this.getSharedPreferences("malzemeiste", Context.MODE_PRIVATE);
...
//        Details_Link_value.setText(getIntent().getStringExtra("Share_Link"));
        ...
        more_item_details_call.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (ActivityCompat.checkSelfPermission(YedekDetailsActivity.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {

                    // Should we show an explanation?
                    ActivityCompat.requestPermissions(YedekDetailsActivity.this,
                            new String[]{Manifest.permission.CALL_PHONE},
                            1);
                } else {

                    YedekDetailsActivity.this.startActivity(callIntent);
        ...
        more_item_details_email.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    YedekDetailsActivity.this.startActivity(Intent.createChooser(intent, "E-posta ile Via ..."));
                } catch (android.content.ActivityNotFoundException ex) {
                    Toast.makeText(YedekDetailsActivity.this, "Hiçbir e-posta istemcisi yüklü değil.", Toast.LENGTH_SHORT).show();
                }
            }
        });
        more_item_details_share.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                YedekDetailsActivity.this.startActivity(Intent.createChooser(sendIntent, "İle paylaş"));
            }
        });
        ...
        Details_Uyumlu_value.setText(getIntent().getStringExtra("Uyumlu"));
        ...
        if (!getIntent().getStringExtra("Image").equals("------"))
            Glide.with(YedekDetailsActivity.this).load(getIntent().getStringExtra("Image")).into(header_details);
