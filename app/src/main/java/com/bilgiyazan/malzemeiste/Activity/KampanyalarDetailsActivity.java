...
public class KampanyalarDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.kampanyalar_details_layout);
        ...
        prefs = KampanyalarDetailsActivity.this.getSharedPreferences("malzemeiste", Context.MODE_PRIVATE);
        siparis_button = (FancyButton) findViewById(R.id.siparis_button);
       // Details_Link_value = (TextView) findViewById(R.id.Details_Link_value);
      //  Details_Link_value.setText(getIntent().getStringExtra("Share_Link"));
        ...
        more_item_details_call.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (ActivityCompat.checkSelfPermission(KampanyalarDetailsActivity.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {

                    // Should we show an explanation?
                    ActivityCompat.requestPermissions(KampanyalarDetailsActivity.this,
                            new String[]{Manifest.permission.CALL_PHONE},
                            1);
                } else {

                    KampanyalarDetailsActivity.this.startActivity(callIntent);
        ...
        more_item_details_email.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    KampanyalarDetailsActivity.this.startActivity(Intent.createChooser(intent, "E-posta ile Via ..."));
                } catch (android.content.ActivityNotFoundException ex) {
                    Toast.makeText(KampanyalarDetailsActivity.this, "Hiçbir e-posta istemcisi yüklü değil.", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        more_item_details_share.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                KampanyalarDetailsActivity.this.startActivity(Intent.createChooser(sendIntent, "İle paylaş"));
            }
        });
        ...
        if (!getIntent().getStringExtra("Image").equals("------"))
            Glide.with(KampanyalarDetailsActivity.this).load(getIntent().getStringExtra("Image")).into(header_details);
